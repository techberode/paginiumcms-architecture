...
return [
    ...
    'invalid_media_icon' => 'Ikona z médií musí byť cesta k obrázku (JPG, PNG, WebP, SVG…).',
    'invalid_lucide_icon' => 'Neplatný názov Lucide ikony.',
    'invalid_thumbnail_size' => 'Neplatná veľkosť miniatúry (sm, md, lg).',
    'invalid_preview_scale' => 'Mierka náhľadu musí byť medzi 1.0 a 3.0.',
];
