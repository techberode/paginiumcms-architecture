        ...
        return [
            ...
            'ui' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'sidebarColor', 'type' => 'enum', 'label' => 'Farba bočného menu', 'default' => 'default', 'options' => ['default', 'navy', 'slate', 'indigo', 'ocean', 'forest', 'wine', 'charcoal'], 'rules' => ['required', 'in:default,navy,slate,indigo,ocean,forest,wine,charcoal'], 'help' => 'Paleta administrácie (nie verejný web). Predvolená = Falcon tokeny podľa svetlého/tmavého režimu.'],
