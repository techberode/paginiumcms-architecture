        ...
        return [
            ...
            'content' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'blogSidebarEnabled', 'type' => 'bool', 'label' => 'Blog — bočný panel', 'default' => false, 'rules' => ['bool'], 'help' => 'It.84b: zobrazí sidebar na /blog (tagy, najnovšie, najčítanejšie).'],
            ...
            'navigation' => [
                ...
                'superAdminOnly' => true,
                'fields' => [
                    ['key' => 'placement', 'type' => 'enum', 'label' => 'Umiestnenie menu', 'default' => 'top', 'options' => ['top', 'side', 'both'], 'rules' => ['required', 'in:top,side,both'], 'help' => 'It.84e: horné menu, bočný strom alebo oboje (desktop).'],
