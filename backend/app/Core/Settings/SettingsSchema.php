 ...
 */public static function groups(): array
    {
        return [
            ...
            'appearance' => [
                'label' => 'Vzhľad',
                'fields' => [
                    ['key' => 'colorScheme', 'type' => 'enum', 'label' => 'Farebná schéma', 'default' => 'indigo-classic', 'options' => ['indigo-classic', 'ocean-slate', 'forest-sage', 'sunset-rose', 'mono-zinc', 'terminal-breach'], 'rules' => ['required', 'in:indigo-classic,ocean-slate,forest-sage,sunset-rose,mono-zinc,terminal-breach'], 'help' => 'Predvolená paleta verejného webu. Tokeny sa načítavajú z frontend katalógu.'],
                    ...
                    ['key' => 'publicTextScaleControlEnabled', 'type' => 'bool', 'label' => 'Zväčšenie textu na webe (horná lišta)', 'default' => true, 'rules' => ['bool'], 'help' => 'Zobrazí ovládanie veľkosti písma pre návštevníkov (localStorage, nezávislé od admin UI).'],
            ...
            'layout' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'breadcrumbsEnabled', 'type' => 'bool', 'label' => 'Zobraziť drobčekovú navigáciu', 'default' => true, 'rules' => ['bool'], 'help' => 'Verejný web: Domov → sekcia → názov stránky alebo článku.'],
            ...
            'content' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'shareEnabled', 'type' => 'bool', 'label' => 'Zdieľanie obsahu', 'default' => true, 'rules' => ['bool'], 'help' => 'Zobrazí tlačidlá zdieľania (Facebook, X, LinkedIn, e-mail, kopírovať odkaz). Bez SDK tretích strán — len intent URL.'],
                    ['key' => 'shareOnArticles', 'type' => 'bool', 'label' => 'Zdieľať články', 'default' => true, 'rules' => ['bool'], 'help' => 'Tlačidlá na detaile publikovaného článku.'],
                    ['key' => 'shareOnPages', 'type' => 'bool', 'label' => 'Zdieľať podstránky', 'default' => false, 'rules' => ['bool'], 'help' => 'Tlačidlá na publikovaných stránkach (nie úvodná).'],
                    ['key' => 'shareFacebook', 'type' => 'bool', 'label' => 'Zdieľať na Facebook', 'default' => true, 'rules' => ['bool']],
                    ['key' => 'shareX', 'type' => 'bool', 'label' => 'Zdieľať na X (Twitter)', 'default' => true, 'rules' => ['bool']],
                    ['key' => 'shareLinkedin', 'type' => 'bool', 'label' => 'Zdieľať na LinkedIn', 'default' => true, 'rules' => ['bool']],
                    ['key' => 'shareEmail', 'type' => 'bool', 'label' => 'Zdieľať e-mailom', 'default' => true, 'rules' => ['bool']],
                    ['key' => 'shareCopy', 'type' => 'bool', 'label' => 'Kopírovať odkaz', 'default' => true, 'rules' => ['bool']],
                    ...
                    ['key' => 'blogSidebarShowTags', 'type' => 'bool', 'label' => 'Sidebar — tagy', 'default' => true, 'rules' => ['bool'], 'help' => 'Zoznam tagov na filtrovanie článkov.'],
                    ['key' => 'blogSidebarShowCategories', 'type' => 'bool', 'label' => 'Sidebar — kategórie', 'default' => true, 'rules' => ['bool'], 'help' => 'Pripravené pre It.84a; zatiaľ prázdne, kým nie sú kategórie.'],
                    ['key' => 'blogSidebarShowLatest', 'type' => 'bool', 'label' => 'Sidebar — najnovšie', 'default' => true, 'rules' => ['bool'], 'help' => 'Kompaktný zoznam posledných publikovaných článkov.'],
                    ['key' => 'blogSidebarShowPopular', 'type' => 'bool', 'label' => 'Sidebar — najčítanejšie', 'default' => true, 'rules' => ['bool'], 'help' => 'Top články podľa pageview (posledných 30 dní).'],
                    ['key' => 'blogSidebarLatestCount', 'type' => 'int', 'label' => 'Sidebar — počet najnovších', 'default' => 5, 'rules' => ['int', 'min:1', 'max:20'], 'help' => 'Koľko položiek v widgete Najnovšie.'],
                    ['key' => 'blogSidebarPopularCount', 'type' => 'int', 'label' => 'Sidebar — počet najčítanejších', 'default' => 5, 'rules' => ['int', 'min:1', 'max:20'], 'help' => 'Koľko položiek v widgete Najčítanejšie.'],
                    ['key' => 'blogListCardSize', 'type' => 'enum', 'label' => 'Blog — veľkosť kariet', 'default' => 'standard', 'options' => ['compact', 'standard', 'comfortable'], 'rules' => ['required', 'in:compact,standard,comfortable'], 'help' => 'Kompaktné karty využijú viac stĺpcov na širokých monitoroch.'],
                    ['key' => 'blogListColumns', 'type' => 'enum', 'label' => 'Blog — stĺpce zoznamu', 'default' => 'auto', 'options' => ['auto', '2', '3', '4'], 'rules' => ['required', 'in:auto,2,3,4'], 'help' => 'auto = podľa sidebaru a veľkosti karty; inak pevný počet stĺpcov od breakpointu sm.'],
                    ['key' => 'blogListWidth', 'type' => 'enum', 'label' => 'Blog — šírka obsahu', 'default' => 'wide', 'options' => ['normal', 'wide', 'full'], 'rules' => ['required', 'in:normal,wide,full'], 'help' => 'Maximálna šírka zoznamu článkov (full = veľké monitory).'],
                    ...
                    ['key' => 'draftFullEditorState', 'type' => 'bool', 'label' => 'Auto-save — celý stav editora', 'default' => false, 'rules' => ['bool'], 'help' => 'Keď je zapnuté, koncept ukladá aj ostatné jazyky, SEO, šablóny a ďalšie polia editora (nie len titulok a obsah aktívnej locale). Odporúčané pri viacjazyčnom obsahu alebo pri úpravách SEO a metadát.'],
                    ...
                    ['key' => 'autoTagEnabled', 'type' => 'bool', 'label' => 'Navrhovanie tagov v editore', 'default' => true, 'rules' => ['bool'], 'help' => 'Povolí tlačidlo „Navrhnúť tagy“ v editore článkov.'],
                    ...
                    ['key' => 'autoDescriptionEnabled', 'type' => 'bool', 'label' => 'Generovanie meta popisu', 'default' => true, 'rules' => ['bool'], 'help' => 'Povolí tlačidlo „Generovať popis“ v editore.'],
                    ...
                    ['key' => 'localeFallbackEnabled', 'type' => 'bool', 'label' => 'Povoliť locale fallback', 'default' => true, 'rules' => ['bool'], 'help' => 'keď požadovaný jazyk chýba, vráti sa defaultLocale resource alebo site.'],
                    ['key' => 'localeNegotiationEnabled', 'type' => 'bool', 'label' => 'Accept-Language pre verejný obsah', 'default' => true, 'rules' => ['bool'], 'help' => 'verejné GET stránok/článkov môže použiť Accept-Language ak chýba ?locale=.'],
                    ['key' => 'staleReviewMonths', 'type' => 'int', 'label' => 'Prah zastarávajúceho obsahu (mesiace)', 'default' => 12, 'rules' => ['int', 'min:0', 'max:120'], 'help' => 'publikovaný obsah starší ako tento počet mesiacov (od posledného review / úpravy / dátumu) sa označí ako zastaralý. 0 = vypnuté.'],
                ],
            ],
            'editor' => [
                'label' => 'Editor',
                'fields' => [
                    ...
                    ['key' => 'markdownToolbar', 'type' => 'string', 'label' => 'Markdown toolbar (It.90)', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Zoradený zoznam capability id (čiarkou). Prázdne = legacy profil + voliteľné rozšírenia.'],
                    ['key' => 'wysiwygToolbar', 'type' => 'string', 'label' => 'WYSIWYG toolbar (It.90)', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Zoradený zoznam capability id pre Tiptap toolbar.'],
            ...
            'translation' => [
                'label' => 'Assisted translation',
                'fields' => [
                    ['key' => 'enabled', 'type' => 'bool', 'label' => 'Enable assisted translation', 'default' => false, 'rules' => ['bool'], 'help' => 'Off = zero outbound traffic. On = editor can request a review proposal. LibreTranslate requires your own instance. Cloud providers send selected text to DeepL or Google. Apply writes a draft only.'],
                    ['key' => 'provider', 'type' => 'enum', 'label' => 'Translation provider', 'default' => 'none', 'options' => ['none', 'libretranslate', 'deepl', 'google'], 'rules' => ['required', 'in:none,libretranslate,deepl,google'], 'help' => 'none = manual only. libretranslate = your own instance + base URL. deepl / google = vendor API key (fixed HTTPS endpoints, no custom URL). Pricing is external and not promised by the CMS.'],
                    ['key' => 'baseUrl', 'type' => 'string', 'label' => 'LibreTranslate base URL', 'default' => '', 'rules' => ['string', 'max:500'], 'help' => 'LibreTranslate only. Production: HTTPS on CMS host via nginx to localhost (e.g. https://site.example/internal/translate). Without /translate suffix. Ignored for DeepL/Google.'],
                    ['key' => 'apiKey', 'type' => 'password', 'label' => 'LibreTranslate API key', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Optional LibreTranslate api_key. Encrypted at rest. Never returned to the frontend after save.'],
                    ['key' => 'deeplApiKey', 'type' => 'password', 'label' => 'DeepL API key', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Encrypted at rest. Keys ending in :fx use api-free.deepl.com; others use api.deepl.com. Never returned after save.'],
                    ['key' => 'googleApiKey', 'type' => 'password', 'label' => 'Google Translation API key', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Cloud Translation v2 API key. Encrypted at rest. Never returned after save. Endpoint is fixed to translation.googleapis.com.'],
                    ['key' => 'googleProjectId', 'type' => 'string', 'label' => 'Google Cloud project ID', 'default' => '', 'rules' => ['string', 'max:128'], 'help' => 'Optional. Stored for admin reference / later v3; the v2 API-key driver does not send service-account JSON.'],
                    ['key' => 'fallbackEnabled', 'type' => 'bool', 'label' => 'Enable explicit failover', 'default' => false, 'rules' => ['bool'], 'help' => 'Off = never switch providers. On = if the primary is unavailable or rate-limited, try the fallback. Auth failures never fail over. Sends the same selected text to the second vendor.'],
                    ['key' => 'fallbackProvider', 'type' => 'enum', 'label' => 'Fallback provider', 'default' => 'none', 'options' => ['none', 'libretranslate', 'deepl', 'google'], 'rules' => ['required', 'in:none,libretranslate,deepl,google'], 'help' => 'Used only when failover is enabled and differs from the primary. none = no fallback.'],
                    ['key' => 'dailyCharLimit', 'type' => 'int', 'label' => 'Daily character quota', 'default' => 0, 'rules' => ['int', 'min:0', 'max:5000000'], 'help' => '0 = unlimited (administrator policy). Counted on source characters sent to the provider.'],
                    ['key' => 'overwriteExisting', 'type' => 'bool', 'label' => 'Overwrite existing locales', 'default' => false, 'rules' => ['bool'], 'help' => 'Off = Translate missing only. On = filled locales can be replaced by a reviewed proposal (still as draft).'],
            ...
            'agent' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'baseUrl', 'type' => 'string', 'label' => 'Provider base URL', 'default' => '', 'rules' => ['string', 'max:500'], 'help' => 'Production: HTTPS on your CMS host via nginx proxy to localhost Ollama (e.g. https://site.example/internal/llm — no /v1). Dev may use http://127.0.0.1:11434. Must pass OutboundUrlGuard.'],
            ...
            'navigation' => [
                'label' => 'Navigácia (layout)',
                'superAdminOnly' => true,
                'fields' => [
                    ['key' => 'placement', 'type' => 'enum', 'label' => 'Umiestnenie menu', 'default' => 'top', 'options' => ['top', 'side', 'both'], 'rules' => ['required', 'in:top,side,both'], 'help' => 'horné menu, bočný strom alebo oboje (desktop).'],
                    ['key' => 'sideBreakpoint', 'type' => 'enum', 'label' => 'Breakpoint bočného menu', 'default' => 'lg', 'options' => ['sm', 'md', 'lg', 'xl'], 'rules' => ['required', 'in:sm,md,lg,xl'], 'help' => 'Pod touto šírkou sa bočné menu skryje (mobilný drawer ostáva v hornom paneli).'],
                    ['key' => 'expandAnimation', 'type' => 'bool', 'label' => 'Animácia rozbaľovania', 'default' => true, 'rules' => ['bool'], 'help' => 'Cascade expand v bočnom menu. Respektuje prefers-reduced-motion.'],
                    ['key' => 'maxDepth', 'type' => 'int', 'label' => 'Max. hĺbka menu', 'default' => 3, 'rules' => ['required', 'int', 'min:3', 'max:4'], 'help' => 'SUPER_ADMIN môže povoliť 4. úroveň; inak max. 3. Pri zapnutom sekundárnom menu ostáva horné menu primárne — bočný stĺpec si sekundárne menu vezme pre seba, aby sa položky neduplikovali.'],
                ],
            ],
            'secondaryNav' => [
                'label' => 'Sekundárne menu (katalóg)',
                'fields' => [
                    ['key' => 'enabled', 'type' => 'bool', 'label' => 'Zapnúť sekundárne menu', 'default' => false, 'rules' => ['bool'], 'help' => 'Samostatný strom (kategória → podkategória → položka). Nezobrazuje tie isté odkazy ako horné menu.'],
                    ['key' => 'maxDepth', 'type' => 'int', 'label' => 'Max. úroveň', 'default' => 3, 'rules' => ['required', 'int', 'min:1', 'max:6'], 'help' => '1–6 úrovní. Napr. náradie → podkategória → produkt.'],
                    ['key' => 'side', 'type' => 'enum', 'label' => 'Umiestnenie', 'default' => 'left', 'options' => ['left', 'right'], 'rules' => ['required', 'in:left,right'], 'help' => 'Ľavý alebo pravý stĺpec vedľa obsahu. Na mobile je v hamburgeri pod hlavným menu.'],
                    ['key' => 'position', 'type' => 'enum', 'label' => 'Pri scrollovaní', 'default' => 'scroll', 'options' => ['scroll', 'sticky'], 'rules' => ['required', 'in:scroll,sticky'], 'help' => 'scroll = ide so stránkou; sticky = ostane v zobrazení. Sticky vždy ukáže len otvorenú vetvu (akordeón).'],
                ],
            ],
            'smtp' => [
                'label' => 'Email / SMTP',
            ...
            'engine' => [
                ...
                'superAdminOnly' => true,
                'fields' => [
                    ['key' => 'deploymentMode', 'type' => 'enum', 'label' => 'Deployment mode', 'default' => 'classic', 'options' => ['classic', 'hybrid', 'git_headless'], 'rules' => ['required', 'in:classic'], 'help' => 'only Classic is active. Hybrid and Git headless appear as not installed.'],
                    ...
                    ['key' => 'cacheDriver', 'type' => 'enum', 'label' => 'Cache driver', 'default' => 'auto', 'options' => ['auto', 'memory', 'file', 'redis'], 'rules' => ['required', 'in:auto,memory,file,redis'], 'help' => 'auto = memory + Redis when REDIS_HOST/engine.redisHost is reachable, else memory + file. redis = require Redis (falls back to file if down). Derived cache only — never SSOT.'],
                    ['key' => 'cacheDefaultTtlSeconds', 'type' => 'int', 'label' => 'Default cache TTL (seconds)', 'default' => 300, 'rules' => ['required', 'int', 'min:60', 'max:86400']],
                    ['key' => 'redisHost', 'type' => 'string', 'label' => 'Redis host', 'default' => '', 'rules' => ['string', 'max:255'], 'help' => 'Empty = use REDIS_HOST from PHP env (Docker service name redis).'],
                    ['key' => 'redisPort', 'type' => 'int', 'label' => 'Redis port', 'default' => 6379, 'rules' => ['required', 'int', 'min:1', 'max:65535']],
                    ['key' => 'redisPassword', 'type' => 'password', 'label' => 'Redis password', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Optional. Encrypted at rest. REDIS_PASSWORD env overrides for container deploy.'],
                    ['key' => 'redisDatabase', 'type' => 'int', 'label' => 'Redis database index', 'default' => 0, 'rules' => ['required', 'int', 'min:0', 'max:15']],
                    ['key' => 'redisKeyPrefix', 'type' => 'string', 'label' => 'Redis key prefix', 'default' => 'paginium:', 'rules' => ['required', 'string', 'max:64'], 'help' => 'Namespace for all cache keys on shared Redis instances.'],
                    ['key' => 'queryIndexDriver', 'type' => 'enum', 'label' => 'Content query index driver', 'default' => 'json', 'options' => ['json', 'sqlite'], 'rules' => ['required', 'in:json,sqlite'], 'help' => 'json = content.json (default). sqlite = optional derived index (It.92); switching to sqlite requires a successful probe/rebuild.'],
                    ['key' => 'queryIndexAdviseEnabled', 'type' => 'bool', 'label' => 'Advise SQLite query index from Performance Guard', 'default' => true, 'rules' => ['bool'], 'help' => 'When Guard sees heavy catalog latency, suggest enabling sqlite driver. Never auto-enables.'],
                    ['key' => 'queryIndexAdviseMinEntries', 'type' => 'int', 'label' => 'Query index advise: min catalog entries', 'default' => 2000, 'rules' => ['required', 'int', 'min:100', 'max:1000000']],
                    ['key' => 'queryIndexAdviseListP95Ms', 'type' => 'int', 'label' => 'Query index advise: list p95 threshold (ms)', 'default' => 0, 'rules' => ['required', 'int', 'min:0', 'max:60000'], 'help' => '0 = use Performance Guard latency warning threshold.'],
                    ['key' => 'queryIndexRuntimeWatchEnabled', 'type' => 'bool', 'label' => 'Watch SQLite query index at runtime', 'default' => true, 'rules' => ['bool'], 'help' => 'When driver is sqlite, detect missing/corrupt index and send throttled monitoring alerts. Catalog still falls back to JSON.'],
                    ['key' => 'queryIndexAutoFallbackOnFailure', 'type' => 'bool', 'label' => 'Auto-revert driver to JSON on SQLite failure', 'default' => false, 'rules' => ['bool'], 'help' => 'Off = alert only (site keeps serving via JSON). On = also set queryIndexDriver back to json after an incident.'],
                    ['key' => 'queryIndexFailureAlertCooldownSeconds', 'type' => 'int', 'label' => 'SQLite index alert cooldown (seconds)', 'default' => 900, 'rules' => ['required', 'int', 'min:60', 'max:86400']],
                    ...
                    ['key' => 'renderMode', 'type' => 'enum', 'label' => 'Public render mode', 'default' => 'dynamic', 'options' => ['dynamic', 'hybrid', 'static'], 'rules' => ['required', 'in:dynamic,hybrid,static'], 'help' => 'dynamic = React SPA + API only. hybrid/static = compile published HTML into storage/app/static/ and serve it at /static-html/{pages|blog}/{slug} (nginx snippet maps pretty URLs). /admin and /api stay dynamic. Save, Build, Git publish stay separate.'],
                    ['key' => 'gitEnabled', 'type' => 'bool', 'label' => 'Enable Git publish distribution', 'default' => false, 'rules' => ['bool'], 'help' => 'Git is distribution only; SSOT stays on disk. Default off (Classic).'],
                    ...
                    ['key' => 'gitPublisher', 'type' => 'enum', 'label' => 'Git publisher driver', 'default' => 'local', 'options' => ['local', 'github_api'], 'rules' => ['required', 'in:local,github_api'], 'help' => 'local = server git binary. github_api = Contents/Git Data API (token + owner/name).'],
                    ['key' => 'gitGithubRepository', 'type' => 'string', 'label' => 'GitHub repository (owner/name)', 'default' => '', 'rules' => ['string', 'max:200'], 'help' => 'Required for github_api. Example: acme/site-content. Validated as owner/name only.'],
                    ['key' => 'gitGithubToken', 'type' => 'password', 'label' => 'GitHub publish token', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Fine-grained or classic token with contents:write on the publish repository. Encrypted at rest. Never returned to the frontend after save.'],
                    ['key' => 'gitRepositoryPath', 'type' => 'text', 'label' => 'Git repository path', 'default' => '', 'rules' => ['string', 'max:500'], 'help' => 'Absolute server path to a Git working tree containing pages/ and blog/ content. Never exposed to the frontend. Used by the local publisher.'],
                    ...
                    ['key' => 'performanceGuardEnabled', 'type' => 'bool', 'label' => 'Enable Performance Guard (APM)', 'default' => false, 'rules' => ['bool'], 'help' => 'lightweight in-request latency and I/O sampling. Disabled by default.'],
            ...
            'marketing' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'footerTechStackEnabled', 'type' => 'bool', 'label' => 'Tech stack vo footeri', 'default' => false, 'rules' => ['bool'], 'help' => 'Diskretný riadok technológií (PHP, React, …) pod sociálnymi sieťami alebo v pätičke.'],
                    ['key' => 'footerTechStackJson', 'type' => 'text', 'label' => 'Tech stack (JSON)', 'default' => '', 'rules' => ['string', 'max:8000'], 'help' => 'Spravované editorom nižšie. Prázdne = predvolené položky.'],
                ],
            ],
            'gallery' => [
            ...
            'ui' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'sidebarColor', 'type' => 'enum', 'label' => 'Farba bočného menu', 'default' => 'default', 'options' => ['default', 'navy', 'slate', 'indigo', 'ocean', 'forest', 'wine', 'charcoal'], 'rules' => ['required', 'in:default,navy,slate,indigo,ocean,forest,wine,charcoal'], 'help' => 'Paleta administrácie (nie verejný web). Predvolená = tokeny podľa svetlého/tmavého režimu.'],
                    ['key' => 'topbarColor', 'type' => 'enum', 'label' => 'Farba hornej lišty', 'default' => 'default', 'options' => ['default', 'navy', 'slate', 'indigo', 'ocean', 'forest', 'wine', 'charcoal'], 'rules' => ['required', 'in:default,navy,slate,indigo,ocean,forest,wine,charcoal'], 'help' => 'Nepriehľadná horná lišta. Nezávislá od farby menu.'],
                    ['key' => 'chromeGradient', 'type' => 'bool', 'label' => 'Gradient na menu a lište', 'default' => false, 'rules' => ['bool'], 'help' => 'Jemný prechod z vybranej farby do tmavšieho tónu. Smer vyberte nižšie.'],
                    ['key' => 'chromeGradientDirection', 'type' => 'enum', 'label' => 'Smer gradientu', 'default' => 'to-bottom', 'options' => ['to-bottom', 'to-top', 'to-right', 'to-left', 'to-bottom-right', 'to-bottom-left'], 'rules' => ['required', 'in:to-bottom,to-top,to-right,to-left,to-bottom-right,to-bottom-left'], 'help' => 'Smer prechodu na bočnom menu aj hornej lište.'],
                    ['key' => 'navPlacement', 'type' => 'enum', 'label' => 'Umiestnenie admin menu', 'default' => 'side', 'options' => ['side', 'top'], 'rules' => ['required', 'in:side,top'], 'help' => 'side = bočný panel; top = horné rozbaľovacie menu podľa sekcií.'],
                    ['key' => 'adminTextScaleControlEnabled', 'type' => 'bool', 'label' => 'Zväčšenie textu v admin UI', 'default' => true, 'rules' => ['bool'], 'help' => 'Ovládanie veľkosti písma v hornej lište administrácie (localStorage, nezávislé od verejného webu).'],
                ],
            ],
            'login' => [
            ...
            'privacy' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'cookiePolicyUrl', 'type' => 'url', 'label' => 'URL zásad cookies / GDPR', 'default' => '', 'rules' => ['string', 'max:500'], 'help' => 'Voliteľný odkaz. Prázdne = vestavná stránka /cookies. Relatívna cesta (napr. /cookies) alebo externá URL.'],
                    ['key' => 'cookieShowRejectButton', 'type' => 'bool', 'label' => 'Tlačidlo „Odmietnuť voliteľné“', 'default' => true, 'rules' => ['bool'], 'help' => 'Zapnuté = návštevník môže odmietnuť voliteľné cookies okrem technicky nutných.'],
                    ['key' => 'cookiePolicyPageTitle', 'type' => 'string', 'label' => 'Nadpis stránky /cookies', 'default' => '', 'rules' => ['string', 'max:200'], 'help' => 'Prázdne = predvolený preklad podľa jazyka webu.'],
                    ['key' => 'cookiePolicyIntro', 'type' => 'text', 'label' => 'Úvodný text stránky /cookies', 'default' => '', 'rules' => ['string', 'max:5000'], 'help' => 'Vlastný úvod pred tabuľkou kategórií. Prázdne = predvolený i18n text.'],
                    ['key' => 'cookiePolicySectionsJson', 'type' => 'text', 'label' => 'GDPR bloky (JSON)', 'default' => '[]', 'rules' => ['string', 'max:30000'], 'help' => 'Spravované vizuálnym editorom nižšie — nadpis + text bloku.'],
                    ['key' => 'privacyContactName', 'type' => 'string', 'label' => 'Kontakt GDPR — meno / prevádzkovateľ', 'default' => '', 'rules' => ['string', 'max:200'], 'help' => 'Prázdne = firemné meno z nastavení Company.'],
                    ['key' => 'privacyContactEmail', 'type' => 'email', 'label' => 'Kontakt GDPR — e-mail', 'default' => '', 'rules' => ['email', 'max:200'], 'help' => 'Prázdne = firemný e-mail z nastavení Company.'],
                    ['key' => 'privacyContactPhone', 'type' => 'string', 'label' => 'Kontakt GDPR — telefón', 'default' => '', 'rules' => ['string', 'max:64'], 'help' => 'Prázdne = telefón z nastavení Company.'],
                    ['key' => 'privacyContactAddress', 'type' => 'text', 'label' => 'Kontakt GDPR — adresa', 'default' => '', 'rules' => ['string', 'max:2000'], 'help' => 'Prázdne = adresa z nastavení Company.'],
                    ['key' => 'cookiePolicyShowCategoriesTable', 'type' => 'bool', 'label' => 'Zobraziť tabuľku kategórií cookies', 'default' => true, 'rules' => ['bool']],
                    ['key' => 'cookiePolicyShowStorageInventory', 'type' => 'bool', 'label' => 'Zobraziť technický inventár úložísk', 'default' => true, 'rules' => ['bool']],
                    ['key' => 'cookiePolicyShowDefaultRights', 'type' => 'bool', 'label' => 'Zobraziť sekciu „Vaše možnosti“', 'default' => true, 'rules' => ['bool']],
                    ['key' => 'cookiePolicyShowManagePanel', 'type' => 'bool', 'label' => 'Zobraziť panel správy súhlasu', 'default' => true, 'rules' => ['bool']],
                ],
            ],
            'security' => [
                'label' => 'Bezpečnosť',
            ...
            'uploadSecurity' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'allowedExtensions', 'type' => 'text', 'label' => 'Povolené prípony', 'default' => 'jpg,jpeg,png,gif,webp,svg,pdf,txt,md,docx,xlsx,pptx,odt,ods,odp,mp4,webm', 'rules' => ['required', 'string', 'max:1000'], 'help' => 'Bez bodky, oddelené čiarkou. Pri zapnutej unified policy (It.78) platí aj profil media/documents/video.'],
            ...
            'accessControl' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'permissionsAdmin', 'type' => 'text', 'label' => 'Oprávnenia ADMIN', 'default' => 'user:manage,content:manage,media:manage,settings:manage,themes:read,themes:edit,git:publish,gallery:manage,project-plan:read,project-plan:manage,time-entry:manage,logs:view,metrics:read', 'rules' => ['required', 'string', 'max:5000']],
                    ['key' => 'permissionsEditor', 'type' => 'text', 'label' => 'Oprávnenia EDITOR', 'default' => 'content:create,content:edit,content:delete,media:upload,media:delete,project-plan:read,project-plan:manage,time-entry:manage', 'rules' => ['required', 'string', 'max:5000']],
            ...
            'media' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'allowedMimeTypes', 'type' => 'text', 'label' => 'Povolené MIME typy', 'default' => 'image/jpeg,image/png,image/gif,image/webp,image/svg+xml,application/pdf', 'rules' => ['required', 'string', 'max:2000'], 'help' => 'Oddeľte čiarkou. Pre video pridajte video/mp4,video/webm (It.79). Ovplyvňuje upload v Media Library.'],
                    ['key' => 'maxUploadSizeKb', 'type' => 'int', 'label' => 'Max. veľkosť uploadu (KB)', 'default' => 5120, 'rules' => ['required', 'int', 'min:64', 'max:51200'], 'help' => '5120 KB = 5 MB. Platí pre obrázky a PDF, nie video.'],
                    ['key' => 'maxVideoUploadSizeKb', 'type' => 'int', 'label' => 'Max. veľkosť video uploadu (KB)', 'default' => 102400, 'rules' => ['required', 'int', 'min:1024', 'max:524288'], 'help' => '102400 KB = 100 MB. Samostatný limit pre video/mp4 a video/webm (It.79).'],
                    ['key' => 'videoPosterRequired', 'type' => 'bool', 'label' => 'Vyžadovať poster pre video v editore', 'default' => false, 'rules' => ['bool'], 'help' => 'Rezervované pre budúcu validáciu v editore (It.79).'],
            ...
            'systemUpdate' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'githubToken', 'type' => 'password', 'label' => 'GitHub token (repo read)', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Optional when a GitHub deploy key is mounted (GITHUB_DEPLOY_SSH_KEY_PATH). A leftover invalid PAT makes admin Verify/Deploy rewrite git@ to HTTPS and fail. Use Clear stored secret, then Save. Needed only for release API compare or HTTPS fetch without a deploy key.'],
