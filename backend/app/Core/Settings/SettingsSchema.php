        ...
        return [
            ...
            'systemUpdate' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'githubToken', 'type' => 'password', 'label' => 'GitHub token (repo read)', 'default' => '', 'rules' => ['string', 'max:512'], 'help' => 'Fine-grained or classic token with read access to code and releases. Required for admin UI deploy from Docker when the git remote uses SSH and the repository is private.'],
