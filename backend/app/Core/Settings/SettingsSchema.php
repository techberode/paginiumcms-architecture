        ...
        return [
            ...
            'translation' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'baseUrl', 'type' => 'string', 'label' => 'LibreTranslate base URL', 'default' => '', 'rules' => ['string', 'max:500'], 'help' => 'Required only for LibreTranslate. URL of YOUR instance (e.g. https://translate.example.com), without /translate. Ignored for DeepL/Google.'],
            ...
            'engine' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'cacheDriver', 'type' => 'enum', 'label' => 'Cache driver', 'default' => 'auto', 'options' => ['auto', 'memory', 'file', 'redis'], 'rules' => ['required', 'in:auto,memory,file'], 'help' => 'auto = memory + file chain. Redis appears when the extension is available.'],
