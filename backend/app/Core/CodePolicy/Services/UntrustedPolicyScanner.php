...
/**
 * Validates all files in an untrusted tree via CodePolicyEngine (It.67b).
 *
 * Shared by plugin, theme, and future module ZIP import pipelines.
 */
final class UntrustedPolicyScanner
{
