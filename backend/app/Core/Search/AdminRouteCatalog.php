...
final class AdminRouteCatalog
{
    ...
    public static function routes(): array
    {
        return [
            ...
            ['id' => 'events', 'title' => 'Udalosti', 'path' => '/events', 'keywords' => 'events udalosti calendar planner', 'adminOnly' => true],
            ['id' => 'time-tracker', 'title' => 'Časovač', 'path' => '/time-tracker', 'keywords' => 'time tracker casovac timer', 'adminOnly' => false],
            ['id' => 'kanban', 'title' => 'Kanban', 'path' => '/kanban', 'keywords' => 'kanban support tickets tabula', 'adminOnly' => false],
            ['id' => 'mail', 'title' => 'Pošta', 'path' => '/mail', 'keywords' => 'mail imap inbox posta', 'adminOnly' => false],
