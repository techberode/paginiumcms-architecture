...
final class UploadSurfaceRegistryTest extends TestCase
{
    public function testEveryInventorySurfaceMapsToProfile(): void
    {
        $expected = [
            ...
            UploadSurfaceRegistry::SURFACE_MEDIA_DOCUMENT_UPLOAD => UploadPolicyProfileId::DOCUMENTS,
            UploadSurfaceRegistry::SURFACE_TEAM_CHAT_UPLOAD => UploadPolicyProfileId::DOCUMENTS,
