...
final class PerformanceAggregatorTest extends TestCase
{
    ...
    public function testSummaryComputesPercentilesAndIoCounters(): void
    {
        ...
        $store->append($this->sample('/api/health', 50.0, 200, 2, 1, 3, 0));
        $store->append($this->sample('/api/health', 250.0, 500, 0, 2, 1, 1));
        $store->append($this->sample('/api/pages', 120.0, 200, 1, 0, 4, 0));
