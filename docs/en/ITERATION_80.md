...
- [x] Register webhook in admin; test ping button.
- [x] Publish triggers signed POST; failure retried; SSRF guard on URL.
- [x] Secret never returned after create (copy-once pattern like API keys).
