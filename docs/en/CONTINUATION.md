...
> **Checkpoint:** September 13, 2026 · `v2.1.0-beta.75`  
...
| Area | Status |
|------|--------|
| Latest tag | ✅ `v2.1.0-beta.75` — It.91 complete (trusted HTML/embeds + runtime i18n) |
| Unreleased (this tree) | — **It.72** S3 remainder · **It.89** plugin SDK |
