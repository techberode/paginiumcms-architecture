...
- Secrets, `.env`, or private ops files (`SECURITY_ISSUES.md`, `PRIVATE_OPS_CHECKLIST.md`, `LOCAL_TEST_LOGS.md`, raw/sanitized test logs). Maintainer template: [`LOCAL_TEST_LOGS.md.example`](../../LOCAL_TEST_LOGS.md.example).
