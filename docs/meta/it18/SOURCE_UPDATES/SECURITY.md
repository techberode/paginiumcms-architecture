...
- **PHPUnit CI log redaction (ISS-120):** GitHub Actions publishes only sanitized backend test output (`.github/scripts/run-backend-tests-ci.sh`). Local sharing: [`LOCAL_TEST_LOGS.md.example`](../../LOCAL_TEST_LOGS.md.example) · [TESTING.md](TESTING.md#test-output--secret-redaction).
