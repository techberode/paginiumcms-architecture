...
> **Snapshot:** `v2.1.0-beta.81` · 17. september 2026  
...
| 11 | **It.58d** Layout remainder | 🟡 | ✅ | shortcodes + layout shell; **58f-a–g** hotové; 58g compile s It.48 |
...
| 26 | **It.93** Admin chrome + denné aplikácie | 🟡 P1 | ✅ shipped | chrome v `beta.77`; **93l** Kanban + **93m** IMAP v `beta.78`; **93m-5** mail polish v `beta.79`; **93l-2** interné poznámky / SLA hotové — [ITERATION_93](ITERATION_93.md) |
...
| 29 | **It.95** Playground (Sandpack) + vlastná knižnica komponentov | 🟡 P1 / 🔵 P2 | ✅ | **95a/c/b/d** hotové — [ITERATION_95](ITERATION_95.md) |
...
|---------|------|----------|
| **It.58d** layout blocks/polish | ✅ | shortcodes + layout shell; 58f-a–g ✅; 58g ostáva |
...
Parallel where safe: It.89 slicey, It.82d, It.58g s It.48, beta fixes, community testing.
