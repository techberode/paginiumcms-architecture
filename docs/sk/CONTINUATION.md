...
> **Checkpoint:** 6. september 2026 · **`v2.1.0-beta.67`**  
...
| Oblasť | Stav |
|--------|------|
| Posledné vydanie | ✅ `v2.1.0-beta.67` — optimalizácia obrázkov v médiách, normalizácia avatarov |
| It.25 wizard | ✅ `beta.62`–`beta.66` (Server → Admin → Web → Infra) |
...
5. **Hotovo** — presmerovanie na `/login` (bez auto-login)

Dokumentácia: [ITERATION_25.md](ITERATION_25.md), [INSTALLATION.md](user/INSTALLATION.md) §7, [RELEASE_2_1_0_BETA_65.md](../en/RELEASE_2_1_0_BETA_65.md), [RELEASE_2_1_0_BETA_67.md](../en/RELEASE_2_1_0_BETA_67.md).
