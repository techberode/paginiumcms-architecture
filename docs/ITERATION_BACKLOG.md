...
**Posledná shipped:** **It.63** admin system update · **`v2.1.0-beta.14`**
...
| **63** | **`v2.1.0-beta.14`** | **[Admin system update (prod)](ITERATION_63.md)** | **✅** | MVP + deploy hotfixes (`beta.13`–`beta.14`) |
