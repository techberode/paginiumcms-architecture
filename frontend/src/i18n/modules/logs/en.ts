...
export const logsEn: MessageTree = {
  ...
  actions: {
    ...
    exportFilteredTxt: 'Export filter (.txt)',
    exportFilteredZip: 'Export filter (.zip)',
  },
  bulk: {
    itemLabel: 'logs',
    archive: 'Archive',
  ...
  toast: {
    ...
    exportSuccess: 'Log export downloaded.',
    exportFailed: 'Log export failed.',
    exportEmpty: 'Nothing to export — adjust filter or selection.',
  },
};
