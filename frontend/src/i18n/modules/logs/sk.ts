...
export const logsSk: MessageTree = {
  ...
  actions: {
    ...
    exportFilteredTxt: 'Export filtra (.txt)',
    exportFilteredZip: 'Export filtra (.zip)',
  },
  bulk: {
    itemLabel: 'logov',
    archive: 'Archivovať',
  ...
  toast: {
    ...
    exportSuccess: 'Export logov stiahnutý.',
    exportFailed: 'Export logov zlyhal.',
    exportEmpty: 'Nič na export — upravte filter alebo výber.',
  },
};
