...
export const adminEn: MessageTree = {
  ...
  confirm: {
    ...
    bulkActionTitle: 'Apply bulk action?',
    proceedTitle: 'Are you sure?',
  ...
  shortcuts: {
    ...
    showShortcuts: 'Show this cheat sheet',
    navigatePalette: 'Move selection in palette',
    selectPalette: 'Open selected result',
    dismissPalette: 'Close palette / dialog',
    openDocs: 'Documentation links open in a new tab from field help (i).',
  },
  checklist: {
    title: 'Getting started',
    subtitle: 'Complete these steps to launch your site with confidence.',
