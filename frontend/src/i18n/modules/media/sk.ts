...
export const mediaSk: MessageTree = {
  ...
  actions: {
    ...
    moveFolder: 'Presunúť',
    copyFolder: 'Kopírovať',
    deleteFolder: 'Zmazať priečinok',
    folderMenu: 'Akcie priečinka',
  ...
  folderPrompt: 'Názov nového priečinka (medzery sa zmenia na pomlčku):',
  folderRenamePrompt: 'Nový názov priečinka:',
  folderMovePrompt: 'Cieľová cesta (napr. kampane/2026 alebo archiv):',
  folderCopyPrompt: 'Cesta pre kópiu priečinka:',
  table: {
    name: 'Názov',
    title: 'Titulok',
    type: 'Typ',
  ...
  confirm: {
    ...
    deleteFolderRecursive: 'Zmazať priečinok „:name“ vrátane všetkých súborov a podpriečinkov? Táto akcia je nevratná.',
  ...
  toast: {
    ...
    folderCreatedAs: 'Priečinok bol vytvorený ako „:name“.',
    folderFailed: 'Nepodarilo sa vytvoriť priečinok.',
    folderDeleted: 'Priečinok bol vymazaný.',
    folderDeleteFailed: 'Zmazanie priečinka zlyhalo.',
    folderMoved: 'Priečinok bol presunutý.',
    folderMoveFailed: 'Presun priečinka zlyhal.',
    folderCopied: 'Priečinok bol skopírovaný.',
    folderCopyFailed: 'Kopírovanie priečinka zlyhalo.',
    urlCopied: 'URL skopírovaná do schránky.',
    downloadStarted: 'Sťahovanie spustené.',
