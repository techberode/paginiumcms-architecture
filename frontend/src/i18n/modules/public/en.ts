...
export const publicEn: MessageTree = {
  ...
  contact: {
    ...
    fields: {
      ...
      phoneHint: 'Enter the country prefix and number without spaces. Valid format: +421909554887',
      subject: 'Subject',
    ...
    toast: {
      ...
      phoneInvalid: 'Phone must be a country prefix and number in the form +421909554887.',
      sent: 'Message sent.',
    },
  },
  company: {
  ...
  comments: {
    ...
    loginRequired: 'Only signed-in users can join the discussion.',
    rating: {
      label: 'Article rating',
      required: 'Choose a rating from 1 to 5 stars.',
      average: 'Average :value of 5 (:count ratings)',
    },
    form: {
      title: 'Add a post',
      name: 'Name',
      ...
      contentPlaceholder: 'Your comment on the article…',
      submitting: 'Sending…',
      submit: 'Post to discussion',
    },
    toast: {
      guestsDisabled: 'Guest discussion is disabled for this article. Please sign in.',
      emailRequired: 'A lasting e-mail address is required.',
      ratingRequired: 'Choose a rating from 1 to 5 stars.',
      pendingApproval: 'Post submitted for approval.',
      published: 'Post published in the discussion.',
    },
