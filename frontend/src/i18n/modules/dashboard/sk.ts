...
export const dashboardSk: MessageTree = {
  ...
  updateBanner: {
    ...
    staleHint: 'Posledná kontrola je staršia ako nastavený interval — pre nové porovnanie kliknite Skontrolovať znova.',
    lastChecked: 'Posledná kontrola: {time}',
    action: 'Otvoriť aktualizáciu',
    refresh: 'Skontrolovať znova',
    checking: 'Kontrolujem aktualizácie…',
    deploy: 'Nasadiť {version}',
    deploying: 'Nasadzujem…',
    configureDeploy: 'Nastaviť deploy',
    details: 'Detail aktualizácie',
    dismiss: 'Skryť',
  },
  panels: {
    locks: {
