...
echo ""
echo "→ Also run stack wrapper permissions (admin deploy readiness — www-data must execute stack.sh):"
echo "   STACK_DIR=/var/lib/docker/compose/paginiumcms APP_ROOT=$APP_ROOT ./scripts/bootstrap-stack-permissions.sh"
echo ""
