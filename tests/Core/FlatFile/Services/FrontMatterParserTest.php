...
namespace tests\Core\FlatFile\Services\FrontMatterParserTest.php;
...
MD;
    ...
    public function testSerialize(): void
    {
        ...
        $this->assertStringContainsString('title: Test Page', $serialized);
        $this->assertStringContainsString('slug: test-page', $serialized);
    }
